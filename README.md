...
## Administrative Capabilities (Control Center)
...
| **OpenAPI Schema (JSON)** | [http://localhost:8000/api/v1/openapi.json](http://localhost:8000/api/v1/openapi.json) | `http://api.localhost.tiangolo.com/api/v1/openapi.json` | Autogenerated OpenAPI 3.1.0 schema specification |
...
The platform exposes autogenerated, OpenAPI 3.1.0-compliant documentation directly from the backend code:

- **Swagger UI (`/docs`)**: Interactive sandbox for testing API endpoints, OAuth2 token authentication, query parameters, request bodies, and viewing live response schemas.
  - Direct: [http://localhost:8000/docs](http://localhost:8000/docs) | Gateway: `http://api.localhost.tiangolo.com/docs`
- **ReDoc (`/redoc`)**: Comprehensive, three-panel reference view optimized for reading data models, field constraints, status codes, and enum definitions.
  - Direct: [http://localhost:8000/redoc](http://localhost:8000/redoc) | Gateway: `http://api.localhost.tiangolo.com/redoc`
- **OpenAPI Schema JSON (`/api/v1/openapi.json`)**: Raw machine-readable OpenAPI specification, consumed by `@hey-api/openapi-ts` for automated TypeScript SDK generation (`python scripts/generate_client.py`).
  - Direct: [http://localhost:8000/api/v1/openapi.json](http://localhost:8000/api/v1/openapi.json) | Gateway: `http://api.localhost.tiangolo.com/api/v1/openapi.json`
