...
from app.schemas.exoplanet import CompositionStats, ExoplanetFilters, ExoplanetStats, HabitabilityStats, SummaryStats, CompletenessStats
...
from app.repositories.exoplanet_stats import (get_by_discovery_method,get_by_discovery_decade,
    get_by_composition, get_habitability_stats,get_summary_stats,get_completeness)
...
def _build_completeness(session) -> CompletenessStats:
    ...
    if total == 0:
        return CompletenessStats(**{field: 0.0 for field in CompletenessStats.model_fields})
